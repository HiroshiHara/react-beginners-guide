...
const jsx4 = React.createClass({
  displayName: 'jsx4',
  _log: function (e) {
    // You can get form-value by "value" property.
    // You should make a distinction between value to defaultValue.
    ...
    return (
      <div className="wrapper">
        <div className="container">
          ...
          <input type="text" placeholder="閉じタグは必須" defaultValue="初期値" onChange={this._log} />
        </div>
      </div>
    )
  }
